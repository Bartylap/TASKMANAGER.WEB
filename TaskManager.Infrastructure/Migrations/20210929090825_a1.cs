        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bufor = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Flats_Constructions_ConstructionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Errands_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarInsurance = table.Column<DateTime>(nullable: false),
                    CarReview = table.Column<DateTime>(nullable: false),
                    Tires = table.Column<string>(nullable: true),
                    ConstructionId = table.Column<int>(nullable: true),
                    TireTypeId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cars", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Cars_Constructions_ConstructionId",
                        column: x => x.ConstructionId,
                        principalTable: "Constructions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cars_ConstructionId",
                table: "Cars",
                column: "ConstructionId");

            migrationBuilder.CreateIndex(
                name: "IX_Cars_TireTypeId",
                table: "Cars",
                column: "TireTypeId");
